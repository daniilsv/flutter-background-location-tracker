...
import '../model/config/android_config.dart';
import '../model/config/background_location_tracker_config.dart';
import '../model/config/ios_config.dart';
...
class ForegroundChannel {
  ...
  static const MethodChannel _foregroundChannel = MethodChannel(
    _FOREGROUND_CHANNEL_NAME,
  );

  static Future<void> initialize(
    Function callbackDispatcher, {
    required BackgroundLocationTrackerConfig config,
  }) async {
    ...
    await _foregroundChannel.invokeMethod<void>('initialize', {
  ...
  static Future<void> startTracking({AndroidConfig? config}) {
    return _foregroundChannel.invokeMethod('startTracking', {
